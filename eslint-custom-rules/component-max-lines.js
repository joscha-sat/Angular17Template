/**
 * @fileoverview Rule to enforce maximum line count for Angular component files
 */
...
module.exports = {
  meta: {
    type: "suggestion",
    docs: {
      description: "enforce maximum line count for Angular component files",
    ...
    messages: {
      exceed: "File has too many lines ({{count}}). Maximum allowed is {{max}}.",
    },
  },
